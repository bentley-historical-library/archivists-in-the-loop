...
{{< banner-heading level="2" color="red" >}}Archivists in the Loop: Archival Reference Services in the Generative AI Moment{{< /banner-heading >}}
...
{{< callout color="maize" >}}
_A meeting of the minds to develop useful, actionable recommendations for how archivists can provide reference services alongside generative AI tools._
{{< /callout >}}
